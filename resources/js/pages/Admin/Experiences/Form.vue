...
const form = useForm({
    ...
    start_date: props.experience?.start_date
        ? props.experience.start_date.split('T')[0]
        : '',
    end_date: props.experience?.end_date
        ? props.experience.end_date.split('T')[0]
        : '',
            ...
            <form @submit.prevent="submit" class="space-y-6">
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-muted-foreground text-xs">
                            Leave empty if it's your current job.
                        </p>
                        <p
                ...
                <div class="space-y-2">
                    <Label for="achievements"
                        >Key Achievements (Optional)</Label
                    >
                    <Textarea
                        id="achievements"
