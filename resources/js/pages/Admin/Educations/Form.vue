...
const form = useForm({
    ...
    start_date: props.education?.start_date ? props.education.start_date.split('T')[0] : '',
    end_date: props.education?.end_date ? props.education.end_date.split('T')[0] : '',
            ...
            <form @submit.prevent="submit" class="space-y-6">
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <p v-if="form.errors.program" class="text-sm text-destructive">{{ form.errors.program }}</p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-muted-foreground">Leave empty if currently studying.</p>
